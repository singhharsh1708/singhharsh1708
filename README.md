...
Google Summer of Code 2026 with <a href="https://sciml.ai/">SciML</a>, under NumFOCUS.<br>
200+ merged pull requests across the projects below.
</p>
...
- [PETScDiffEq.jl](https://github.com/SciML/PETScDiffEq.jl) - common-interface bindings for the PETSc `TS` time integrators. New in SciML, registered in General.
...
- [OrdinaryDiffEq.jl](https://github.com/SciML/OrdinaryDiffEq.jl) - the ODE time integrators, and where most of my work lives. I added the serial spectral deferred correction solver family, the explicit MRI-GARK multirate methods and the order-10 MSRK10 tableau, along with correctness fixes across the Rosenbrock, FIRK and ESDIRK solvers.
...
- [ModelingToolkit.jl](https://github.com/SciML/ModelingToolkit.jl) - symbolic-numeric modelling.
- [SciMLOperators.jl](https://github.com/SciML/SciMLOperators.jl) - lazy operator algebra.
- [NonlinearSolve.jl](https://github.com/SciML/NonlinearSolve.jl) and [SciMLBase.jl](https://github.com/SciML/SciMLBase.jl) - the solver interfaces underneath all of it.
